...
import { Card, Modal, PageHeader, Caption, Button, StatCard, fieldInputClass } from "../../";
...
import LendingDetailModal from "../../features/modals/LendingDetailModal.jsx";
import LendingFormFields from "../lending/LendingFormFields.jsx";
import LendingRequestModal from "../lending/LendingRequestModal.jsx";
...
const Lending = () => {
  ...
  const inputClass = (field) => fieldInputClass(Boolean(formErrors[field]));
  ...
  return (
    <div className="ct-page">
      ...
      <div className="grid grid-cols-2 gap-3">
        <StatCard value={formatInr(totals.lentOut)} label="You lent (outstanding)" />
        <StatCard value={formatInr(totals.borrowedIn)} label="You owe (debt)" valueClassName="text-violet-300" />
        <StatCard value={formatInr(totals.recovered)} label="Recovered (lent)" valueClassName="text-emerald-300" />
        <StatCard value={formatInr(totals.repaid)} label="Repaid (debt)" />
      </div>
