...
/**
 * Home glance block — ONE Perovo Score + four pillar cards (research Stage 4).
 */
export default function HomePerovoDashboard() {
  ...
  return (
    <section className="ct-stack-sm" aria-label={t("perovoScore.title")}>
      ...
      >
        ...
        <p className="text-xs text-[var(--ct-text-secondary)] mt-2 relative leading-snug">
          {t("perovoScore.homeHint")}
        </p>
      </button>
            ...
            <MetricCard
              ...
              context={
                pillar.id === "cashflow" && perovo.freeCash > 0
                  ? t("perovoScore.pillarContext.cashflow", { amount: formatInr(Math.round(perovo.freeCash)) })
