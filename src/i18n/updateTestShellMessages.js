/** English-only copy for the temporary update test APK (keeps bundle small). */
export default {
  "updateTestShell.title": "Update test",
  "updateTestShell.body":
    "Small test build. Tap Update — downloads inside the app with a progress bar, then restarts automatically.",
