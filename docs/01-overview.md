...
- **Modes (V1)** — **salaried only** (single-user). Removed modes (freelancer, student, business, family/household) migrate to salaried on load. Tools and copy live in `constants/modeExperience.js`.
