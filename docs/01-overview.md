...
- **Subscriptions** — `free` / `pro` / `power` tiers (`constants/subscriptionTiers.js`). Pro/Power unlock features via `ProGate`; upgrades use Razorpay checkout (`services/razorpaySubscription.js`).
